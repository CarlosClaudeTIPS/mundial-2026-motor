...
const MARKET_META = {
  ...
  sot_1h:          { label: 'SOT 1H',             risk: 32, category: 'sot'     },
  tarjetas_1h:     { label: 'Tarjetas 1H',        risk: 45, category: 'cards'   },
...
export function generateCandidates(calc, _odds, teamA, teamB) {
  ...
  const markets = [
    ...
    { key: 'sot_1h',           expected: calc.t.sot1h,    step: 1 },
    { key: 'tarjetas_1h',      expected: calc.t.cards1h,  step: 0.5 },
